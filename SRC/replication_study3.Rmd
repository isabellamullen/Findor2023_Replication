...
legend("topright", legend = legend_labels, fill = c("lightblue", "lightgreen", "pink", "lavender"), xpd = TRUE,  c(-0.15, 0), cex = 0.5)
...
ggplot(s3, aes(x = E3, fill = group)) +
  ...
  labs(title = "Support for Housing Project by Condition",
       ...
       y = "Count",
       fill = "Group") +
  scale_fill_manual(values = c("blue", "darkblue", "grey", "brown")) +
  theme_minimal()
