...
s3personal_alter <- polr(E3 ~ group + AGE + EDU + SEX + REG, data = s3,
                          Hess=TRUE)
...
```{r}
# AIC comparison
AIC(s3personal, s3personal_alter)

# BIC comparison
BIC(s3personal, s3personal_alter)
```
...
```{r}
lrtest(s3personal, s3personal_alter)
```
